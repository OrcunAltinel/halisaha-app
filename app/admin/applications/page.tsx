                ...
                <div className="p-5 sm:p-6">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-600">{app.address}</p>
                    </div>
                      ...
                      <div className="grid grid-cols-2 gap-2 sm:grid-cols-5">
                        {app.image_urls.map((url, idx) => (
                          ...
                          <a    key={url} 
                            ...
                            className="aspect-square overflow-hidden rounded-lg bg-gray-100 ring-1 ring-gray-200 transition hover:ring-gray-400"
                          >
