  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <section className="prose prose-gray max-w-none space-y-8 text-gray-700">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">1. About Halisaha</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">3. Bookings and Cancellations</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">4. Pitch Owners</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">6. Liability</h2>
          <p>
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">7. Account Suspension</h2>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            <a href="mailto:hello@halisaha.com" className="text-black underline">
              hello@halisaha.com
            </a>.
          </p>
        </div>
